...
def MGSSolver( scenario: ScenarioModel ) -> ICUAllocationResponseModel:
    model = Model(  )
    ...
    model.setObjective( survival_in_icu + survival_out_icu - occupancy_penalty - cost, GRB.MAXIMIZE )
